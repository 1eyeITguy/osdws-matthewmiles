...
start /wait PowerShell -NoProfile -Command "Write-Host 'Rebooting in 30 seconds... Press Ctrl+C to cancel' -ForegroundColor Yellow; Start-Sleep -Seconds 30; exit 0"
